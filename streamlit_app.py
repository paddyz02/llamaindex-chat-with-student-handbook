...
st.title("Chat with Food Recipes Copilot")
st.write(
...
if not openai_api_key:
    ...
    if "messages" not in st.session_state.keys():  # Initialize the chat messages history
        st.session_state.messages = [
            {"role": "assistant", "content": "I am Food Recipes Copilot, your personal assistant for weeknight meals. You can ask me about for quick and easy recipe ideas!"}
        ]
